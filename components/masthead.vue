  ...
  <div class="max-w-6xl m-auto">
    ...
    <div class="md:grid-cols-2 grid md:px-2 lg:px-10 gap-6 pb-20">
      <Imagebox url="/zydecobreakfeast.jpg" title="Zydeo Breakfast" alt="People Dancing"
        sub-title="2-step with us every saturday at 8:00 am">
        <div class="text-textLight grid grid-cols-2 p-2 gap-10">
          <div class="bg-lightRed py-1">
            <div class="clip-right bg-lightRed"></div>
            <NuxtLink
              to="https://www.google.com/maps/dir/30.1334528,-92.0387584/buck+and+johnnys/@30.2056649,-92.0394119,12z/data=!3m1!4b1!4m9!4m8!1m1!4e1!1m5!1m1!1s0x8624868557ce87c3:0xcf24eb268818e33!2m2!1d-91.9000351!2d30.2729471"
          ...
          <div class="bg-darkRed py-2">
            ...
            <NuxtLink to="/zydeco-breakfast"
              ...
              <div class="uppercase">view schedule</div>
            </NuxtLink>
          </div>
        </div>
      </Imagebox>

      <Imagebox url="/accordian2.jpg" title="live music weekly" alt="People Dancing"
        sub-title="local talent and incredible food">
        <div class="text-textLight grid grid-cols-2 p-2 gap-10">
          <div class="bg-lightRed py-1">
            <div class="clip-right bg-lightRed"></div>
            <NuxtLink
      ...
      <Imagebox url="/menu.jpg" title="Menu" alt="Food" sub-title="Award-Winning Cuisine">
        <div class="text-textLight grid grid-cols-2 p-2 gap-10">
          <div class="bg-lightRed py-1">
            <div class="clip-right bg-lightRed"></div>
            <NuxtLink to="menu" class="flex items-center font-bold text-sm justify-center h-full w-full text-center py-1">
      ...
      <Imagebox url="/ordernow.jpg" title="Order Now" alt="People Dancing" sub-title="and pick up ready to go">
        <div class="text-textLight grid grid-cols-2 p-2 gap-10">
          <div class="bg-lightRed py-1">
            <div class="clip-right bg-lightRed"></div>
            <NuxtLink to="https://buckandjohnnys.hrpos.heartland.us/menu"
      ...
      <Imagebox url="/bookevent.jpg" title="Book an event" alt="People Dancing" sub-title="beautiful event space options">
        <div class="text-textLight grid grid-cols-2 p-2 gap-10">
          <div class="bg-lightRed py-1">
            <div class="clip-right bg-lightRed"></div>
            <NuxtLink to="special-events"
              class="flex items-center font-bold text-sm justify-center h-full w-full text-center py-1">

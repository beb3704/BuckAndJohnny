  ...
  <div class="max-w-6xl m-auto">
    <div class="grid justify-center pb-6 pt-4">
      <NuxtImg
        format="webp"
        quality="100"
        sizes="sm:200px md:300px lg:350px"
        src="/logo.png"
        alt="logo"
    ...
    <div class="md:grid-cols-2 grid md:px-2 lg:px-10 gap-6 pb-20">
      <Imagebox
        url="/zydecobreakfeast.jpg"
        title="Zydeco Breakfast"
        alt="People Dancing"
      ...
      <Imagebox
        ...
        title="Menu"
        alt="Food"
        sub-title="Award-Winning Cuisine"
      >
        <div class="text-textLight grid grid-cols-2 p-2 gap-10">
          <div class="bg-lightRed py-1">
            <div class="clip-right bg-lightRed"></div>
      ...
      <Imagebox
        ...
        title="Merchandise"
        alt="People Dancing"
        sub-title="grab some cajun swag"
      >
        <div class="text-textLight grid grid-cols-2 p-2 gap-10">
          <div class="bg-lightRed py-1">
            <div class="clip-right bg-lightRed"></div>
